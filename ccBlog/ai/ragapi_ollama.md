...
tags:
  - ai
image: /img/ccBlog/ai/ragapi_ollama.png
...
![](../assets/blog/ai/ragapi_ollama/1.png)
...
![](../assets/blog/ai/ragapi_ollama/2.png)
...
![](../assets/blog/ai/ragapi_ollama/3.png)
...
![](../assets/blog/ai/ragapi_ollama/4.png)
...
![](../assets/blog/ai/ragapi_ollama/5.png)
...
![](../assets/blog/ai/ragapi_ollama/6.png)
...
![](../assets/blog/ai/ragapi_ollama/7.png)
...
![](../assets/blog/ai/ragapi_ollama/8.png)
...
![](../assets/blog/ai/ragapi_ollama/9.png)

5. 在 **数据处理** 页面，进行以下配置：
    1. 点击 **配置大模型** > **Ollama**，选择刚添加的大模型实例，并选择 `qwen3:8b`。
    2. 点击 **批量操作** > **大模型嵌入**，选择需要嵌入的字段，并全选表。
    
  ![](../assets/blog/ai/ragapi_ollama/10.png)
  ![](../assets/blog/ai/ragapi_ollama/11.png)

6. 在 **创建确认** 页面，点击 **创建任务**，开始运行。

![](../assets/blog/ai/ragapi_ollama/12.png)
...
![](../assets/blog/ai/ragapi_ollama/13.png)

3. 在 **功能配置** 页面，任务类型选择 **全量迁移**，任务规格选择默认 2 GB 即可。
4. 在 **表&action过滤** 页面，选择要使用的向量表（可多选）。

![](../assets/blog/ai/ragapi_ollama/14.png)
...
![](../assets/blog/ai/ragapi_ollama/15.png)

6. 在 **创建确认** 页面，点击 **创建任务**，系统将自动完成 RagApi 服务构建。

![](../assets/blog/ai/ragapi_ollama/16.png)
...
![](../assets/blog/ai/ragapi_ollama/17.png)
...
![](../assets/blog/ai/ragapi_ollama/18.png)

    - **模型名称**：CC_RAG

![](../assets/blog/ai/ragapi_ollama/19.png)

3. 回到对话页面：
    - 点击 添加助手 > Default Assistant。
    - 右键点击 Default Assistant > 编辑助手 > 模型设置，绑定上一步添加的模型。

![](../assets/blog/ai/ragapi_ollama/20.png)

4. 在对话框输入：`MySQL 源端权限需要什么？`，RagApi 将根据向量数据检索相关内容，并通过对话模型生成响应。			

![](../assets/blog/ai/ragapi_ollama/21.png)
