...
tags:
  - ai
image: https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/ccBlog/ai/rag_concept.png
slug: /ai/rag_concept
---
## 简介
...
![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/ai/rag_concept/1.png)
...
![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/ai/rag_concept/2.png)
...
![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/ai/rag_concept/3.png)
...
![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/ai/rag_concept/4.png)

+ 用户提问：“天气如何？”由于未明确城市信息，AI 无法直接调用工具，此时应追问用户所在城市。

![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/ai/rag_concept/5.png)

+ 用户回复：“杭州”。AI 获取了查询所需的关键信息，提取参数后生成 tool_calls。此时，应用程序识别到 requires_tools: true，根据 tool_calls 调用相应工具函数。

![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/ai/rag_concept/6.png)

+ 工具执行完成后，结果返回给 AI，AI 再基于结果进行总结并回复用户。

![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/ai/rag_concept/7.png)
...
![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/ai/rag_concept/8.png)
...
### MCP 多轮对话流程
![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/ai/rag_concept/9.png)

+ 在多轮对话中，当用户输入：“北京天气如何？”

![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/ai/rag_concept/10.png)
...
![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/ai/rag_concept/11.png)
...
![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/ai/rag_concept/12.png)
...
![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/ai/rag_concept/13.png)
...
![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/ai/rag_concept/14.png)
...
![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/ai/rag_concept/15.png)
...
![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/ai/rag_concept/16.png)
...
![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/ai/rag_concept/17.png)

    - **模型名称**：填写 **CC_RAG**

![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/ai/rag_concept/18.png)
...
![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/ai/rag_concept/19.png)
...
![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/ai/rag_concept/20.png)
...
1. 进入 CloudCanal，点击任务详情页右上角「功能列表」>「修改参数」。
...
![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/ai/rag_concept/21.png)
