...
tags:
  - data_sync_sample
image: https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/ccBlog/data_sync_sample/multi_version_schema.png 
...
![image.png](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/wufenzhong/0029/1.png)
...
![image.png](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/wufenzhong/0029/2.png)
...
- Kafka 需要先创建一个 **DDL** **Topic**，用于后续 Topic 订阅。
  ![image.png](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/wufenzhong/0029/3.png)
...
- 点击下一步。
  ![image.png](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/wufenzhong/0029/4.png)

- 因为这里只订阅 DDL，只勾选**ALTER，RENAME，TRUNCATE**。
  ![image.png](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/wufenzhong/0029/5.png)

- 持续点击下一步，并创建出数据同步任务。
- 任务自动做**增量同步，进行 DDL 订阅。**
  ![image.png](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/wufenzhong/0029/6.png)
...
![image.png](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/wufenzhong/0029/7.png)

- 同样也可以使用 Kafka 消费程序直接消费 DDL 信息，多个消费程序可以对 Schema 信息进行复用，具体 Demo 详情见：[Kafka 消费实例程序](https://gitee.com/clougence/public-demo)

![image.png](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/wufenzhong/0029/8.png)
