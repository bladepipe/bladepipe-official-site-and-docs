...
tags:
  - data_sync_sample
image: /img/ccBlog/data_sync_sample/oracle_starrocks_sync.png 
...
- 登录CloudCanal平台
- **数据源管理**->**添加数据源**
  ![添加数据源](../assets/blog/wufenzhong/0030/1.png)

- 创建源端数据源：选择**自建数据源**，选择Oracle，并填写相关数据库信息
  ![image.png](../assets/blog/wufenzhong/0030/2.png)
  - **logminerUser**
...
- 创建目的端数据源，选择**自建数据源**，选择StarRocks，并填写相关数据库信息
  ![image.png](../assets/blog/wufenzhong/0030/3.png)
...
- 数据源创建成功
  ![image.png](../assets/blog/wufenzhong/0030/4.png)

### 任务创建

- 任务管理->创建任务
  ![image.png](../assets/blog/wufenzhong/0030/5.png)
...
- 点击下一步
  ![image.png](../assets/blog/wufenzhong/0030/6.png)

- 选择**增量同步**，并且勾选**全量初始化**
- 点击下一步
  ![image.png](../assets/blog/wufenzhong/0030/7.png)

- 选择订阅的表
- 点击下一步
  ![image.png](../assets/blog/wufenzhong/0030/8.png)

- 配置列映射
- 点击下一步
  ![image.png](../assets/blog/wufenzhong/0030/9.png)

- 点击创建任务
  ![image.png](../assets/blog/wufenzhong/0030/10.png)

- 任务创建成功并启动后，会自动执行结构迁移、全量迁移、增量同步
  ![image.png](../assets/blog/wufenzhong/0030/11.png)
