...
tags:
  - data_sync_sample
image: https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/ccBlog/data_sync_sample/oracle_mysql_sync.png 
...
- 选择 **自建数据源** ，并填写相关数据库信息，其中 **网络地址** 请按提示带上端口号
  ![9d87303b-45dd-4bd1-bd73-f053b59046cf-image.png](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/data_sync_sample/9_oracle_mysql_sync/9d87303b-45dd-4bd1-bd73-f053b59046cf-image.png)

- 如下已添加完 Oracle 和 MySQL
  ![a718b8f7-7961-4a1d-bb41-445ba81c0037-image.png](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/data_sync_sample/9_oracle_mysql_sync/a718b8f7-7961-4a1d-bb41-445ba81c0037-image.png)

### 创建同步任务
- **任务管理**->**新建任务**
- 源端选择刚添加的 Oracle 数据源，目标选择 MySQL, 分别点击 **测试连接** 按钮以测试数据库连通性和获取 schema 级别元信息
- 点击**下一步**
  ![1a3d90f2-4efb-49d8-b579-8919e9debca6-image.png](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/data_sync_sample/9_oracle_mysql_sync/1a3d90f2-4efb-49d8-b579-8919e9debca6-image.png)

- 选择 **数据同步**，并且勾选**全量数据初始化**
- 规格可以根据任务重要度以及部署机器的内存容量合理选择，一般 2GB 内存规格即可
- 点击**下一步**
  ![a3722630-7625-4485-ad56-3340d3fd904d-image.png](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/data_sync_sample/9_oracle_mysql_sync/a3722630-7625-4485-ad56-3340d3fd904d-image.png)


- 勾选需要同步的表，如果目标表为橙色，表示不存在同名表，任务创建完成后自动进行**结构迁移**。也可以下拉框选择表进行映射
- 勾选需要同步的 INSERT/UPDATE/DELETE 操作，默认全选
- 点击**下一步**
  ![c70a7c0f-cbd9-4f6a-849c-21c607cf769e-image.png](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/data_sync_sample/9_oracle_mysql_sync/c70a7c0f-cbd9-4f6a-849c-21c607cf769e-image.png)

- 通过勾选做**列映射**和**列裁剪**
- 点击**下一步**
  ![d20d2906-6ba5-4fea-bd43-f2033aa3509e-image.png](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/data_sync_sample/9_oracle_mysql_sync/d20d2906-6ba5-4fea-bd43-f2033aa3509e-image.png)

- 对任务内容进行创建 ，如果任务不需要立刻运行 , 可置灰**自动启动任务** 按钮
- 点击**确认创建**
  ![77f49016-0cec-4d33-93d1-a94b741d788f-image.png](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/data_sync_sample/9_oracle_mysql_sync/77f49016-0cec-4d33-93d1-a94b741d788f-image.png)

### 任务同步
- 任务分为 3 个阶段：**结构迁移**、**数据初始化**、**数据同步**，每一个阶段完成时，状态自动流转，直到同步稳态
  ![afd38301-a854-4543-b814-8782ed1c094d-image.png](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/data_sync_sample/9_oracle_mysql_sync/afd38301-a854-4543-b814-8782ed1c094d-image.png)
  ![c2772d7c-2ab7-470c-8551-280f723221ad-image.png](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/data_sync_sample/9_oracle_mysql_sync/c2772d7c-2ab7-470c-8551-280f723221ad-image.png)
...
![8f3f8d80-437a-4ce9-b3d6-450a0f5e0466-image.png](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/data_sync_sample/9_oracle_mysql_sync/8f3f8d80-437a-4ce9-b3d6-450a0f5e0466-image.png)
