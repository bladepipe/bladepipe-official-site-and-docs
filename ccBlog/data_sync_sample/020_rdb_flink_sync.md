...
tags:
  - data_sync_sample
image: https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/ccBlog/data_sync_sample/rdb_flink_sync.png 
...
![image.png](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/wufenzhong/0020/image1.png)
...
- 登录 CloudCanal 平台，添加 Kafka，MySQL
  ![截屏2022-08-17 17.12.13.png](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/wufenzhong/0020/image2.png)

- Kafka 自定义一个主题 **topic_1**，并创建一条 MySQL -> Kafka 链路作为增量数据来源
### 任务创建

- 首先配置 **FlinkDemo程序的**阿里云 Kafka 相关信息
  ![截屏2022-08-17 17.09.12.png](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/wufenzhong/0020/image3.png)

- 运行 **FlinkDemo** 程序，等待消费 MySQL 同步 Kafka 的数据（程序不要关闭）
  ![截屏2022-08-17 17.08.50.png](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/wufenzhong/0020/image4.png)

- **任务管理** -> **任务创建**
- **测试链接**并选择 **源** 和 **目标** 数据库，**并选择 DebeziumEnvelope 消息格式，和 topic_1 主题**(在阿里云里提前创建)
  ![截屏2022-08-17 17.08.18.png](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/wufenzhong/0020/image5.png)

- 选择 **数据同步**，不勾选 **全量数据初始化**，其他选项默认
  ![截屏2022-08-17 17.07.46.png](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/wufenzhong/0020/image6.png)
- 选择需要迁移同步的表 **table1**和对应的 Kafka 主题 **topic_1**
  ![截屏2022-08-17 17.07.19.png](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/wufenzhong/0020/image7.png)
- 持续点击下一步，并创建出数据同步任务。
...
- **FlinkDemo** 接收到 **Kafka(topic_1)** 数据，下沉到 topic_2 主题，打印并输出；这里 Flink 程序**可以做更多的流式计算的操作**，FlinkDemo 只是演示了**最基本的数据传输案例**。
  ![截屏2022-08-17 17.10.05.png](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/wufenzhong/0020/image8.png)
