...
tags:
  - data_sync_sample
image: /img/ccBlog/data_sync_sample/rocketmq_http_base_internet_data_sync.png 
...
* 建议对数据源进行描述修改，防止配置正反链路时，识别错数据库
  ...
  ![53bdb8eb-d4cc-45cb-b114-ea8fb0dc7755-image.png](../assets/blog/wufenzhong/0017/1.png)
...
* 确认创建
  ![696865b5-1121-4ba4-a4e5-8617302148cf-image.png](../assets/blog/wufenzhong/0017/2.png)

* 任务详情 -> 参数设置
  ·设置目标 DATASOURCE 参数配置 **nameServer** 参数为阿里云RocketMQ 的 **HTTP** 协议客户端公网访问接入点
  ·设置目标 DATASOURCE 参数配置 protocol 为 **HTTP**
  ·生效配置并启动
  ![8d7ed86c-d152-4e29-a6da-3f84c25135f0-image.png](../assets/blog/wufenzhong/0017/3.png)
...
* 第三个、第四个页面
  ...
  ·点击 下一步
* 确认创建
  ![1473637d-5475-4061-baf6-5571fd74e9f1-image.png](../assets/blog/wufenzhong/0017/4.png)

* 任务详情 -> 参数设置
  ·设置源端 DATASOURCE 参数配置 nameServer 参数为阿里云RocketMQ 的 HTTP 协议客户端公网访问接入点
  ·设置源端 DATASOURCE 参数配置 protocol 为 HTTP
  ·生效配置并启动
  ![dfb7282d-31b4-4db2-9598-a057106dbcb0-image.png](../assets/blog/wufenzhong/0017/5.png)
