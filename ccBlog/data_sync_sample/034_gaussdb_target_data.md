...
tags:
  - data_sync_sample
image: /img/ccBlog/data_sync_sample/gaussdb_target_data.png 
...
- 任务管理 -> 新建任务
- 测试连接并选择 源 和 目标 数据库
  ![](../assets/blog/wufenzhong/0034/1.png)
- 点击下一步
  ![](../assets/blog/wufenzhong/0034/2.png)

- 选择 数据同步，并勾选全量数据初始化以及开启一次性校验，其他选项默认
  ![](../assets/blog/wufenzhong/0034/3.png)

- 选择需要迁移同步的表
  ![](../assets/blog/wufenzhong/0034/4.png)
  ![](../assets/blog/wufenzhong/0034/5.png)

- 确认创建任务
  ![](../assets/blog/wufenzhong/0034/6.png)

- 任务自动执行结构迁移、全量同步和增量同步，执行数据校验，结果显示数据校验通过
  ![](../assets/blog/wufenzhong/0034/7.png)
