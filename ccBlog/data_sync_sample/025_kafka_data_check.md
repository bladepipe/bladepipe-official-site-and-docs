...
tags:
  - data_sync_sample
image: /img/ccBlog/data_sync_sample/kafka_data_check.png 
...
- 登录 CloudCanal 平台，添加 Kafka，MySQL
  ![image.png](../assets/blog/wufenzhong/0025/01.png)
...
-  kafka 自定义一个主题 **topic_1**，并创建一条 MySQL(1) -> Kafka 链路作为增量数据来源
  ...
  ![image.png](../assets/blog/wufenzhong/0025/02.png)
...
- **测试链接**并选择 **源** 和 **目标** 数据库，**并选择 DebeziumEnvelope 消息格式，和 topic_1 主题**
  ![image.png](../assets/blog/wufenzhong/0025/03.png)

- 选择 **数据同步**，不勾选 **全量数据初始化**，其他选项默认
  ![image.png](../assets/blog/wufenzhong/0025/04.png)

- 选择需要迁移同步的表 **table1**和对应的 Kafka 主题 **topic_1**
  ![image.png](../assets/blog/wufenzhong/0025/05.png)

- 没有主键自动忽略，方便后序生成数据
  ![image.png](../assets/blog/wufenzhong/0025/06.png)

- 确认创建任务，创建成功后在源端配置页面设置 **SchemaInclude** 参数为 **true**
  ![image.png](../assets/blog/wufenzhong/0025/07.png)

- 然后点击生效配置，确认重启
  ![image.png](../assets/blog/wufenzhong/0025/08.png)

## 任务创建 2 **[ Kafka -> MySQL(2) ]**

- **任务管理** -> **任务创建**
- **测试链接**并选择 **源** 和 **目标** 数据库
  ![image.png](../assets/blog/wufenzhong/0025/09.png)

- 选择 **数据同步**，其他选项默认
- 选择消费的 Kafka 主题 **topic_2**和需要迁移同步的表 **table1**
  ![image.png](../assets/blog/wufenzhong/0025/10.png)
...
- 创建 MySQL 到 MySQL 的数据准确校验
  ![image.png](../assets/blog/wufenzhong/0025/11.png)

- 选着数据校验功能，其他的默认
  ![image.png](../assets/blog/wufenzhong/0025/12.png)

- 数据校验 OK
  ![image.png](../assets/blog/wufenzhong/0025/13.png)
