...
tags:
  - data_sync_sample
image: /img/ccBlog/data_sync_sample/oceanbase_source_sync.png 
...
![截屏2022-03-04 上午10.47.57.png](../assets/blog/data_sync_sample/18_oceanbase_source_sync/截屏2022-03-04-上午10.47.57.png)
...
![截屏2022-03-04 上午10.44.41.png](../assets/blog/data_sync_sample/18_oceanbase_source_sync/截屏2022-03-04-上午10.44.41.png)
...
- 选择 数据源管理->新增数据源
- 选择 自建数据库中的OceanBase
  ![截屏2022-03-04 上午10.50.05.png](../assets/blog/data_sync_sample/18_oceanbase_source_sync/截屏2022-03-04-上午10.50.05.png)

  ![8b6cf03f-dfba-494e-8057-e344d5a60036-image.png](../assets/blog/data_sync_sample/18_oceanbase_source_sync/8b6cf03f-dfba-494e-8057-e344d5a60036-image.png)
...
- 选择 源 和 目标 数据库
- 点击 下一步
  ![09de85cb-04de-41d2-9d2b-d0651f631a0a-image.png](../assets/blog/data_sync_sample/18_oceanbase_source_sync/09de85cb-04de-41d2-9d2b-d0651f631a0a-image.png)

- 选择 增量同步，并且启用 全量数据初始化
- 点击下一步
  ![截屏2022-03-04 上午10.55.35.png](../assets/blog/data_sync_sample/18_oceanbase_source_sync/截屏2022-03-04-上午10.55.35.png)

- 选择订阅的表，结构迁移自动创建的表会按照默认类型映射进行处理。对端表如果已经提前建好，这里也可以直接映射对端已经存在的表
- 点击下一步
  ![截屏2022-03-04 上午10.56.54.png](../assets/blog/data_sync_sample/18_oceanbase_source_sync/截屏2022-03-04-上午10.56.54.png)

- 配置列映射、点击下一步
  ![截屏2022-03-04 上午10.58.23.png](../assets/blog/data_sync_sample/18_oceanbase_source_sync/截屏2022-03-04-上午10.58.23.png)
  >如果是通过 CloudCanal 结构迁移自动建表，这边不允许重命名、裁剪以及列映射; 如果映射的是对端已经提前建好的表，这边支持列的裁剪和映射

- 创建任务
  ![截屏2022-03-04 上午10.59.39.png](../assets/blog/data_sync_sample/18_oceanbase_source_sync/截屏2022-03-04-上午10.59.39.png)

- 查看任务状态。任务创建后，会自动完成结构迁移、全量、增量阶段。
  ![7bfb7478-aa5d-4b86-823c-3ad377a9219b-image.png](../assets/blog/data_sync_sample/18_oceanbase_source_sync/7bfb7478-aa5d-4b86-823c-3ad377a9219b-image.png)
