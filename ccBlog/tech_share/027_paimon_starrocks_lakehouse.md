...
tags:
  - tech_share
image: /img/ccBlog/tech_share/paimon_starrocks_lakehouse.png
...
## 构建湖仓一体架构
尽管 Paimon 可以通过 Flink CDC 写入数据，但管理作业状态、处理容错和检查点等工作，对多数团队而言仍有不小的技术门槛和运维成本。CloudCanal 提供了一种**更轻量、更自动化**的方式实现数据入湖。![](../assets/blog/tech_share/0027/1.png)
...
![](../assets/blog/tech_share/0027/2.png)
...
![](../assets/blog/tech_share/0027/3.png)
...
![](../assets/blog/tech_share/0027/4.png)

3. 在 **功能配置** 页面，选择 **增量同步**，并勾选 **全量初始化**。

![](../assets/blog/tech_share/0027/5.png)

4. 在 **表和操作过滤** 页面，选择需要迁移同步的表，可同时选择多张。

![](../assets/blog/tech_share/0027/6.png)

5. 在 **数据处理** 页面，保持默认配置。

![](../assets/blog/tech_share/0027/7.png)
6. 在 **创建确认** 页面，点击 **创建任务**，开始运行。

![](../assets/blog/tech_share/0027/8.png)
...
![](../assets/blog/tech_share/0027/9.png)
