...
tags:
  - tech_share
image: /img/ccBlog/tech_share/kafka_src_debezium_json_sync.png
...
![image.png](../assets/blog/tech_share/0013/1.png)
...
![image.png](../assets/blog/tech_share/0013/2.png)
![image.png](../assets/blog/tech_share/0013/3.png)
![image.png](../assets/blog/tech_share/0013/4.png)

### 创建同步任务
- **任务管理**-> **新建任务**
- **Kafka** 选择 **Debezium Envelope Json Format** 格式
- 该消息格式的说明，参见：[源端 Kafka Debezium Json 使用说明](/docs/reference/debezium_json_notice)
![image.png](../assets/blog/tech_share/0013/5.png)
![image.png](../assets/blog/tech_share/0013/6.png)

- Kafka 消息中如果有 **Schema**，需要在 **任务详细 -> 参数修改 -> 源数据源配置** 中修改  **envelopSchemaInclude** 为 **true**
![image.png](../assets/blog/tech_share/0013/7.png)

### 同步测试
- 源端数据库做数据变更，Debezium 将数据写入 Kafka 后，CloudCanal 会写入到 Starrocks 中。
![image.png](../assets/blog/tech_share/0013/8.png)

- 数据同步结束后校验 MySQL 和 Starrocks 的数据，40 万左右的数据是一致的。
![image.png](../assets/blog/tech_share/0013/9.png)
