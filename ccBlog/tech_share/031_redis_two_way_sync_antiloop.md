...
tags:
  - tech_share
image: https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/ccBlog/tech_share/redis_two_way_sync_antiloop.png
...
![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/tech_share/redis_two_way_sync_antiloop/1.png)
...
![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/tech_share/redis_two_way_sync_antiloop/2.png)
...
![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/tech_share/redis_two_way_sync_antiloop/3.png)
...
![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/tech_share/redis_two_way_sync_antiloop/4.png)
...
![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/tech_share/redis_two_way_sync_antiloop/5.png)
...
![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/tech_share/redis_two_way_sync_antiloop/6.png)

![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/tech_share/redis_two_way_sync_antiloop/7.png)

在目标端数据库做数据变更，查看监控图表，可以看到，反向任务显示有变更，正向任务没有，即代表无数据循环。

![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/tech_share/redis_two_way_sync_antiloop/8.png)

![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/tech_share/redis_two_way_sync_antiloop/9.png)



创建数据校验任务，可以看到，两端数据库的数据保持一致。

![](https://cloudcanal-blog-img.oss-cn-hangzhou.aliyuncs.com/blog/tech_share/redis_two_way_sync_antiloop/10.png)
