...
const config: Config = {
  ...
  customFields: {
    ...
    announcement: {
      ...
      text: 'BladePipe 2.0.0: Support Google Ads and more, improve SAP HANA source CDC performance.', // 公告文本（支持 i18n）
      linkUrl: '/docs/releaseNote/rn-bladepipe-2-0-0/', // 链接地址（整个区域可点击）
