...
| 可禁用  | 是                                                                                             | 否                                                                                             | 否                                                                                             |
| 默认引擎 | 内置                                                                                            | 内置                                                                                            | 内置                                                                                            |
| 可用引擎 | 内置、[钉钉](engine/dingtalk_approval)、[飞书](engine/feishu_approval)、[企业微信](engine/wechat_approval) | 内置、[钉钉](engine/dingtalk_approval)、[飞书](engine/feishu_approval)、[企业微信](engine/wechat_approval) | 内置、[钉钉](engine/dingtalk_approval)、[飞书](engine/feishu_approval)、[企业微信](engine/wechat_approval) |
