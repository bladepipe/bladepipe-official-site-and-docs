...
<table>
  ...
  <tr>
    ...
    <td style={{backgroundColor: '#f8f8f8'}}>数据源(21种)</td>
    <td style={{backgroundColor: '#ffffff'}}>
        <b>MySQL</b>、<b>Oracle</b>、<b>MariaDB</b>、<b>PostgreSQL</b>、<b>IBM DB2（IBM i 及 z/OS）</b>、<b>SQL Server</b>、
        <b>OceanBase(MySQL 及 Oracle)</b>、<b>PolarDB-X</b>、<b>PolarDB(MySQL)</b>、<b>TiDB</b>、<b>Greenplum</b>、
        <b>阿里云 AnalyticDB(MySQL)</b>、<b>阿里云 RDS(MySQL)</b>、<b>阿里云 RDS(PostgreSQL)</b>、<b>阿里云 PolarDB(MySQL)</b>、<b>阿里云 PolarDB-X</b>、
