...
description: 本文档主要介绍如何将 CloudDM Team 产品接入 Active Directory 以实现统一身份认证。
---

本文档主要介绍如何将 CloudDM Team 产品接入企业自身 **Active Directory 域** 以实现统一身份认证。
...
- 当启用后 CloudDM Team 的账号有效性验证将会由 **Active Directory域服务** 验证。
...
![w600_h200](../../assets/operation/sso/sso_ad/use-ad-cn.png)

- 在登录页面选择 **子账号登录**，输入 Active Directory 域用户的用户名和密码。
- 在点击登录按钮后，CloudDM Team 会和 Active Directory 域服务通信以验证用户身份。
