...
id: sso_wechat
title: 企业微信身份认证
description: 本文档将介绍 CloudDM 产品接入企业微信以实现统一身份认证。
---

![w400_h280](../../assets/integrations/sso/sso_wechat/use-wechat-cn.png)

CloudDM 允许您的组织在使用 [企业微信](https://work.weixin.qq.com/) 时，通过团队为您分配的企业微信账号进行登录，从而实现统一身份认证。
...
:::info
您可以将 [企业微信审批](../approval/wechat_approval.md) 和登录整合进同一个应用，CloudDM 支持独立或分开配置它们。
:::
...
2. 填写应用的基础信息，涉及图标资源可以到 **[资源下载](../../resource/resource_download)** 获取。应用可用范围选择组织机构的 **根部门(包含所有员工)**，然后点击 **保存**。
...
3. 在 **应用详情** 中找到 **网页授权及JS-SDK** 卡片，点击 **设置可信域名**，根据引导完成可信域名的配置。
   ![common](../../assets/integrations/sso/sso_wechat/app-step5.png)
4. 在 **应用详情** 中找到 **企业可信 IP** 卡片，点击 **设置**，填写您部署 CloudDM 环境中公网出口 IP。
   ![common](../../assets/integrations/sso/sso_wechat/app-step6.png)
5. 在 **应用详情** 中设置 **应用主页**。
   ![common](../../assets/integrations/sso/sso_wechat/app-step7.png)

**访问应用**
1. 打开 **[企业微信客户端](https://work.weixin.qq.com/#indexDownload)**，在工作台中搜索您创建的 CloudDM 应用。
   ![common](../../assets/integrations/sso/sso_wechat/app-step8.png)
2. 点击 **应用** 会进入 CloudDM 登录页面，在 **子账号登录** 中选择 **企业微信登录** 即可。
   ![common](../../assets/integrations/sso/sso_wechat/app-step9.png)
