...
id: role_info_admin
title: 管理员
description: 本文将详细介绍 CloudDM Team 内置管理员的角色的具体权限点，该角色适用于管理该系统的用户。
---

本文将详细介绍 CloudDM Team 内置 **管理员** 的角色的具体权限点，该角色适用于管理该系统的用户。
...
| [查询配置查看](../roleauth/roleauth_query#dm_ds_read)                                        | 具备该权限的用户或角色可以 **查看** CloudDM Team 中**查询配置的页面**和**详情**。                                             |
...
| [主账号偏好配置查看](../roleauth/roleauth_pri_settings#rdp_pri_user_kv_conf_r)                  | 具备该权限的用户或角色可以 **查看** CloudDM Team 中系统偏好的参数列表。                                                      |
| [主账号配置修改](../roleauth/roleauth_pri_settings#rdp_pri_user_kv_conf_w)                    | 具备该权限的用户或角色可以 **查看** 、 **修改** CloudDM Team 中系统偏好的参数列表。                                             |
| [主账号 AccessKey 和 SecretKey 查看](../roleauth/roleauth_pri_settings#rdp_pri_user_ak_sk_r) | 具备该权限的用户或角色可以 **查看** CloudDM Team 中系统偏好的AccessKey 和 SecretKey 查看功能。                                |
| [主账号普通配置查看](../roleauth/roleauth_pri_settings#rdp_pri_user_normal_conf_r)              | 具备该权限的用户或角色可以 **查看** CloudDM Team 中系统偏好的普通配置（验证邮箱、手机号）功能。                                          |
...
| [项目/变更管理](../roleauth/roleauth_project#project_manage)                                 | 具备该权限的用户或角色可以 **操作** CloudDM Team 中 **项目列表** 、**项目详情** 和 **变更详情** 页面中的功能包括 **新增**、**删除**、**归档**项目。 |
| [变更执行](../roleauth/roleauth_project)                                                   | 具备该权限的用户或角色可以 **操作** 处于 **SQL 执行** 环节的变更。                                                          |
| [IM 服务配置查看](../roleauth/roleauth_im#im_read)                                           | 具备该权限的用户或角色可以 **查看** CloudDM Team 中 **IM** 配置页面。                                                   |
| [IM 服务配置管理](../roleauth/roleauth_im#im_manage)                                         | 具备该权限的用户或角色可以 **操作** CloudDM Team 中 **IM** 页面中的功能包括：**添加**、**删除**、**测试**。                          |
| [CI/CD 服务配置查看](../roleauth/roleauth_cicd#cicd_read)                                    | 具备该权限的用户或角色可以 **查看** CloudDM Team 中 **CI/CD** 配置页面。                                                |
| [CI/CD 服务配置管理](../roleauth/roleauth_cicd#cicd_manage)                                  | 具备该权限的用户或角色可以 **操作** CloudDM Team 中 **CI/CD** 页面中的功能包括：**添加**、**删除**、**测试**。                       |
