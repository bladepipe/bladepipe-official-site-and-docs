...
---
Your production [SQL Server](/connector/sql-server/) is struggling.
...
You're searching for "SQL Server CDC to [Kafka](/connector/kafka/)" because you need near real-time Change Data Capture (CDC) without breaking production. **Good news:** there *is* a simpler way to do this. This guide covers two practical methods to get the job done:
