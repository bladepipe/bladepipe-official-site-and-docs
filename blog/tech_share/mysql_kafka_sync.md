...
This tutorial describes how to move data from [MySQL](/connector/mysql/) to [Kafka](/connector/kafka/) with [BladePipe](https://www.bladepipe.com), using the CloudCanal Json Format by default. The key features of the pipeline include: 
