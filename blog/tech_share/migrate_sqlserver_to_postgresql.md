...
---
If you've been thinking about migrating from [SQL Server](/connector/sql-server/) to [PostgreSQL](/connector/postgresql/), you're not alone. More and more teams are making the switch, whether it's to cut licensing costs, embrace open source, or get better flexibility in the cloud.
