...
| Deployment Options | Cloud (Managed & BYOC)/Self-hosted(Docker/K8s/Binary)     | Self-hosted(OSS)/Cloud (Managed)  |
...
**BladePipe**, on the other hand, focuses on depth over breadth. It now supports [**60+ connectors**](https://www.bladepipe.com/connector/), which are **all self-built and actively maintained**. It targets critical real-time infrastructure: OLTPs, OLAPs, message middleware, search engines, data warehouses/lakes, vector databases, etc. This makes it a better fit for real-time applications, where data freshness and change tracking matter more than diversity of sources. 
...
## BladePipe vs Airbyte: Use Cases
...
### Airbyte Pricing Models
Airbyte has five plans to consider:
- **Core**: Open source. Free to use for self-hosted deployment.
- **Standard**: $2.50 per credit, and start at $10/month(4 credits). Billed based on data volume.
- **Plus**: Custom pricing for cloud deployment. Billed on an annual basis. Talk to the sales team on specific costs.
- **Pro** & **Enterprise**: Custom pricing for cloud deployment. Billed based on capacity. Talk to the sales team on specific costs.


### Summary
Here's a quick comparison of costs between BladePipe Managed and Airbyte Standard.

| Million Rows per Month | BladePipe (Managed) | Airbyte (Standard) |
| -- |-------------------| -- |
| 1 M | $10              | $450  |
| 10 M | $100              | $1000  |
| 100 M | $1000             | $3000  |
