---
id: api_constant_supportdstdeploytypes
title: 目标端部署类型
description: 接口描述：获取系统支持的目标端数据源部署类型列表
---
...
`/cloudcanal/console/api/v1/openapi/constant/supportdstdeploytypes`
...
| HUAWEI_CLOUD_HOSTED | 华为云      |
| TENCENT_CLOUD_HOSTED | 腾讯云      |
| INDEPENDENT_CLOUD_PLATFORM | 独立云平台    |
...
```json
{
    ...
    [
        ...
        {
            "i18nName": "独立云平台",
            "envType": "INDEPENDENT_CLOUD_PLATFORM"
        }
    ],
    "success": true,
    "fail": false
