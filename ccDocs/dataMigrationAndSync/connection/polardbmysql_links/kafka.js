export const Kafka = {
    ...
    master_function: [
        {
            key: 'Topic 映射规则',
            desc: '默认按 . 拼接源端 <b>实例id</b>、<b>库</b>、<b>表</b> 形成对端 topic 进行匹配或待创建（如 pc-vgpq6q097174t6t.dingtax.app_key），额外支持按 <b>源端一致</b>、<b>转小写</b>、<b>转大写</b> 映射'
        },
        {
            key: '表级别 Topic',
        ...
        {
            key: '兼容 Online DDL',
            desc: '兼容 <b>GH-OST</b>, <b>PT-OSC</b>, <b>Aliyun DMS Online DDL</b>, 变更完毕之后，同步具备最新结构的消息（如新增、修改后的列，去掉删除掉的列）'
        },
        {
            key: '定时全量迁移',
