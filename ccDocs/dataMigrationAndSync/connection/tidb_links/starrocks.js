export const StarRocks = {
    ...
    examples: [
        {
            key: 'CloudCanal x TiDB 数据迁移同步',
            desc: '文档：[CloudCanal x TiDB 数据迁移同步](https://www.clougence.com/blog/data_insights/tidb_change_data_capture)'
        }
    ],
    faq: [
        '[StarRocks 对端结构迁移如何设置分区?](../../operation/datasource_func/StarRocks/starrocks_partition)'
    ],
    mapping: [
        {
            source: 'BIT',
