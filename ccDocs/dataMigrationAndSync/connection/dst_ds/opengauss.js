export const OpenGauss = {
    prepare: [
        {
            key: '账号权限',
            desc: '具备 <b>SELECT</b>, <b>INSERT</b>, <b>DELETE</b>, <b>UPDATE</b>,常见 <b>DDL</b> 权限 <br />'
        },
        {
            key: '网络准备',
            desc: '迁移同步节点（sidecar）可连接 OpenGauss 标准交互接口（如 5432）'
        }
    ],
    params: [
        {
        ...
        {
            key: 'timezone',
            desc: '目标端 OpenGauss 时区，例如 +08:00 Asia/Shanghai America/New_York'
        },
        {
            key: 'defaultZeroDate',
