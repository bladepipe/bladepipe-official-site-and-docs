export const AutoMQ = {
    ...
    params: [
        ...
        {
            key: 'compressionType',
            desc: 'AutoMQ <b>compression.type</b> 参数, 设置压缩算法, 支持 <b>GZIP</b>, <b>SNAPPY</b>, <b>LZ4</b>, <b>ZSTD</b> 算法'
        },
        {
            key: 'batchSize',
            desc: 'AutoMQ <b>batch.size</b> 参数'
        },
        {
            key: 'acks',
            desc: 'AutoMQ <b>acks</b> 参数, 默认 <b>all</b>'
        },
        {
            key: 'maxRequestBytes',
            desc: 'AutoMQ <b>max.request.size</b> 参数'
        },
        {
            key: 'lingerMs',
            desc: 'AutoMQ <b>linger.ms</b> 参数, 默认 1'
        },
        {
