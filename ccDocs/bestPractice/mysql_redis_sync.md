...
- Redis 如果为一个集群，可填写所有节点或所有 master 节点，以英文逗号分割
  ...
  ![mysql_redis_sync_add_ds](../assets/mysql_redis_sync/mysql_redis_sync_add_ds.png)
...
- 点击**下一步**
  ...
  ![mysql_redis_sync_first_step](../assets/mysql_redis_sync/mysql_redis_sync_first_step.png)

- 选择 **数据同步**，并且勾选 **全量数据初始化**，点击 **下一步**

  ![mysql_redis_sync_second_step](../assets/mysql_redis_sync/mysql_redis_sync_second_step.png)

- 选择需要迁移同步的表
- 因为 Redis 内数据 key 由源端数据主键构成，故无主键表数据迁移同步会不正常，所以不建议勾选
- 点击 **下一步**

  ![mysql_redis_sync_third_step](../assets/mysql_redis_sync/mysql_redis_sync_third_step.png)

- 选择需要迁移同步的列
- 点击 **下一步**

  ![mysql_redis_sync_fouth_step](../assets/mysql_redis_sync/mysql_redis_sync_fouth_step.png)

- 确认创建任务，并正常运行

  ![mysql_redis_sync_final_step](../assets/mysql_redis_sync/mysql_redis_sync_final_step.png)

  ![mysql_redis_sync_data_job_normal](../assets/mysql_redis_sync/mysql_redis_sync_data_job_normal.png)
...
- 创建校验任务，结果一致
  ...
  ![mysql_redis_sync_data_correct](../assets/mysql_redis_sync/mysql_redis_sync_data_correct.png)
