...
## 技术点
![api_sync_1.png](../assets/api_sync/api_sync_1.png)
...
- 此例以 18443 端口作为 Tunnel 数据源监听端口
  ![api_sync_2.png](../assets/api_sync/api_sync_2.png)
- CloudCanal 上添加 Tunnel 数据源和目标数据源
  ![api_sync_3.png](../assets/api_sync/api_sync_3.png)

### 为目标端数据库初始化元数据

- 因无法通过 Tunnel 到对端数据库做结构迁移，所以需要事先使用 mysqldump 等工具初始化对端数据库结构
  ![api_sync_4.png](../assets/api_sync/api_sync_4.png)

### 为 Tunnel 初始化元数据

- 创建一个 MySQL -> Tunnel 结构迁移
  ![api_sync_5.png](../assets/api_sync/api_sync_5.png)
  ![api_sync_6.png](../assets/api_sync/api_sync_6.png)

### 任务创建

- 选择 Tunnel 和 目标数据库
  ![api_sync_7.png](../assets/api_sync/api_sync_7.png)

- 选择数据同步
  ![api_sync_8.png](../assets/api_sync/api_sync_8.png)

- 选择表、列、映射略
- 任务正常运行，监听端口并准备接收数据
  ![api_sync_12.png](../assets/api_sync/api_sync_12.png)

### 应用代码开发

- 依赖 [cloudcanal-tunnel-sdk](https://gitee.com/clougence/cloudcanal-tunnel-sdk/tree/master) 进行客户端代码开发
  ![api_sync_13.png](../assets/api_sync/api_sync_13.png)
...
- 写入数据，并观察任务监控指标([代码参考](https://gitee.com/clougence/cloudcanal-tunnel-sdk/blob/master/src/test/java/com/clougence/cloudcanal/tunnel/sdk/biz/writer/TunnelDataSyncApplyTest.java))
  ![api_sync_14.png](../assets/api_sync/api_sync_14.png)
