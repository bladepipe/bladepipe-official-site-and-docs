...
## 技术点
![image.png](../assets/http_sync/http_sync_all.png)
...
- 杭州环境部署 CloudCanal ，并购买 RDS for MySQL 作为源端
  ![http_sync_3](../assets/http_sync/http_sync_3.png)
  ![http_sync_4](../assets/http_sync/http_sync_4.png)

- 深圳环境部署 CloudCanal  ,  并购买 RDS for MySQL 作为目标端
  ![http_sync_1](../assets/http_sync/http_sync_1.png)
  ![http_sync_2](../assets/http_sync/http_sync_2.png)
...
- 此例以 18443 端口作为 Tunnel 数据源监听端口
  ![http_sync_5](../assets/http_sync/http_sync_5.png)
  ![http_sync_6](../assets/http_sync/http_sync_6.png)
...
- 分别在源端和目标端 CloudCanal 配置 Tunnel 数据源
  ![http_sync_7](../assets/http_sync/http_sync_7.png)

- 源端数据源列表，源端的 Tunnel 地址应当是目标端 Tunnel 所在服务器的地址
  ![http_sync_9](../assets/http_sync/http_sync_9.png)

- 目标端数据源列表  
  ![http_sync_8](../assets/http_sync/http_sync_8.png)

### 为 Tunnel 初始化元数据

- 源端创建一个 MySQL -> Tunnel 结构迁移，并完成
  ![http_sync_10](../assets/http_sync/http_sync_10.png)
  ![http_sync_11](../assets/http_sync/http_sync_11.png)

- 从源端 Tunnel 数据源拷贝结构并复制到目标端
  ![http_sync_12](../assets/http_sync/http_sync_12.png)
  ![http_sync_13](../assets/http_sync/http_sync_13.png)
  ![http_sync_14](../assets/http_sync/http_sync_14.png)

### 目标端任务创建

- 选择 Tunnel 和 目标数据库
  ![http_sync_15](../assets/http_sync/http_sync_15.png)

- 选择数据同步
  ![http_sync_16](../assets/http_sync/http_sync_16.png)

- 选择表、列、映射略
- 任务正常运行，监听端口并准备接收数据
  ![http_sync_17](../assets/http_sync/http_sync_17.png)

### 源端任务创建

- 选择源端数据库 和 Tunnel 数据源
  ![http_sync_18](../assets/http_sync/http_sync_18.png)

- 选择数据同步，并初始化数据
  ![http_sync_19](../assets/http_sync/http_sync_19.png)

- 数据持续同步中
  ![http_sync_20](../assets/http_sync/http_sync_20.png)

### 数据验证
#### 造增量数据

- 为了造数据简便，开下源端数据库公网地址
  ![http_sync_21](../assets/http_sync/http_sync_21.png)

#### 数据校验

- 在深圳环境添加源端数据源，并做数据校验。结果显示数据一致。
  ![http_sync_22](../assets/http_sync/http_sync_22.png)
  ![http_sync_23](../assets/http_sync/http_sync_23.png)
