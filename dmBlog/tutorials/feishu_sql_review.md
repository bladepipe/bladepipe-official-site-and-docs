...
1. 点击 **凭证与基础信息**，复制 **App ID**、**App Secret**，为 CloudDM 配置作准备。  
...
8. 进入 [开发文档](https://open.feishu.cn/document/server-docs/approval-v4/event/event-interface/subscribe)，点击 **尝试一下**。 
