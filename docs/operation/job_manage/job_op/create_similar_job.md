...
Click **Functions** > **Create Similar DataJob** in the upper-right corner of DataJob Details page.

BladePipe will read the configuration of the selected DataJob and automatically fill out the setup form in the process of creating a new DataJob. Users can make some adjustments to complete the creation of a similar DataJob.
