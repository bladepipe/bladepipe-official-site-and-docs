    ...
    master_function: [
        {
            ...
            desc: 'By default, Topic is formed by connecting source <b>instance id</b>, <b>database</b>, and <b>table</b> with . in between. Also, it supports the mapping rules, namely, <b>keeping the name the same as that in Source</b>, <b>converting the text to lowercase</b>, <b>converting the text to uppercase</b>.'
        },
        {
