    ...
    main_function: [
        {
            ...
            desc: 'If the target schema does not exist, BladePipe will automatically generate and execute CREATE statements based on the source metadata and the mapping rule. This feature is not applicable to the tables without primary keys.'
        },
        {
            key: 'Full Data Migration',
            desc: 'Migrate data by sequentially scanning data in tables and writing it in batches to the target database. This feature is not applicable to the tables without primary keys.'
        },
        {
            key: 'Incremental Data Sync',
            desc: 'Sync of common DML like <b>INSERT</b>, <b>UPDATE</b>, <b>DELETE</b> is supported. This feature is not applicable to the tables without primary keys.'
        },
        {
    ...
    master_function: [
        {
            ...
            desc: 'Supports synchronization for <b>GH-OST</b>, <b>PT-OSC</b>, <b>Aliyun DMS Online DDL</b>, and <b>PT_GHOST</b>.'
        },
        {
