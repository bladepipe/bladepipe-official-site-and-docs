export const PolarDbX = {
    ...
    master_function: [
        {
            key: 'Setting Partition Key',
            desc: 'Support table-level DB (database partitioning) or DB_TAB (database and table partitioning) setup, using partition functions such as HASH, WEEK, MM, DD, MMDD.'
        },
        {
            key: 'Partition Key-based Write',
            desc: 'Automatically add partition key values in UPDATE and DELETE operations based on partition key settings, improving write performance.'
        },
        {
            key: 'Custom Code',
