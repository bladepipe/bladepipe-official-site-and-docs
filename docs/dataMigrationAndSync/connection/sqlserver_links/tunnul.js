const Tunnel = {
    main_function: [
        ...
        {
            key: 'DDL Sync',
            desc: 'Supports ALTER TABLE ADD COLUMN and DROP COLUMN.'
        }
    ],
    master_function: [
        {
    ...
    examples: [
        {
            ...
            desc: 'See [Cross-Internet Data Synchronization](https://www.clougence.com/cc-doc/bestPractice/http_internet_data_sync)'
        },
    ],
    faq: []
};
