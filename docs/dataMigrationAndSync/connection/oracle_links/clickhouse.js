export const ClickHouse = {
    main_function: [
        ...
        },
        {
            ...
            desc: 'Verify all existing data. Scheduled DataTasks are supported. <br /> For more information, see [Create Verification and Correction DataJob](../../../operation/job_manage/create_job/create_period_verification_correction_job).'
        },
        {
        ...
        {
            key: 'DDL Sync',
            desc: '- ALTER TABLE ADD, MODIFY, DROP COLUMN <br /> - TRUNCATE TABLE'
        },
        {
