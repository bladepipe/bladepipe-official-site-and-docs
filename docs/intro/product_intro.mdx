...
id: product_intro
title: Overview
description: BladePipe is a data synchronization and migration tool that helps enterprises build high-quality data pipelines with real-time efficiency, precise interconnection, stability and scalability, one-stop, hybrid deployment, and complex data transformation.
---
import DataSourceLinkForEn from "@site/src/components/DataSourceLinkForEn";

BladePipe is a real-time end-to-end data replication tool for building sub-second and stable data pipelines. It offers a one-stop data movement solution, ranging from schema evolution, data migration and sync to monitoring and alerting. All is done in an automated and visualized way.  
