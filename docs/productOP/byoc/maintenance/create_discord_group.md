...
description: It guides you to set up a Discord bot, so that users can receive alert notifications on Discord.
---
...
- Create a server
  ...
  ![](../../../assets/create_discord_group/1.png)

  ![](../../../assets/create_discord_group/2.png)
  
  ![](../../../assets/create_discord_group/3.png) 
  
  ![](../../../assets/create_discord_group/4.png)

- Configure WebHook

  ![](../../../assets/create_discord_group/5.png)

  ![](../../../assets/create_discord_group/6.png)

- Obtain the webhook

  ![](../../../assets/create_discord_group/7.png)
...
- After the Discord alert group is successfully created, and the Discord webhook is filled in the BladePipe **User Avatar**>**Account**>**User Setting**, subsequent BladePipe DataJob alerts will be sent to this group.
  ...
  ![](../../../assets/create_discord_group/8.png)
